...
(function () {
  ...
  function boot(cfg) {
    ...
    style.textContent = [
      ...
      // Panel (form or voice)
      '.panel{position:absolute;bottom:72px;right:0;width:340px;max-height:calc(100vh - 160px);background:#1e293b;border-radius:16px;box-shadow:0 8px 36px rgba(0,0,0,.45);overflow:hidden;display:flex;flex-direction:column;opacity:0;transform:translateY(14px) scale(.97);transition:opacity .2s,transform .2s;pointer-events:none}',
